<template>
	<div class="buydetail">
		...
		<div class="cente" v-if="itme">
			<div >
				<div class="time1">
					<ul>
						<li class="li1">
							<div class="li1_top">
								<p id="p1">{{itme.title}}</p>
								<p id="a1">{{itme.add_time}}</p>
							</div>
							<div class="money">
								<img style="width: 25px; height: 25px; border-radius: 50%" src="job_salary.png" alt="">
								<p style="color: #D22D72;">{{itme.settlement}}/招{{itme.people_num}}</p>
							</div>
						</li>
						<li class="li2">
							<div>
								<img style="width: 22px; height: 22px; " src="job_map.png" alt="">
								<p>{{itme.merchant_name}}/{{itme.address}}/{{itme.job_time}}</p>
							</div>
				...
				<div class="head_portrait ">
					<li class="head_portrait1">
						<div class="head_portrait2">
							<p style="font-weight:600;">{{itme.company_name}}</p>
							<p id="font1">{{itme.company_address}}</p>
						</div>
						<img style="width: 50px; border-radius: 50%; margin-right: 10px; " :src="itme.logo" alt="">
					</li>
				</div>
				<p style="background-color: #efefef; height:10px; margin-top: 0px;"></p>
				<div class="job_description">
					<p style="font-weight:600;">职位描述</p>
					<p id="jb">{{itme.need}}</p>
				</div>
				<p style="background-color: #efefef; height:10px; margin-top: 0px;"></p>
				<div class="bottom">
					<p>联系方式</p>
					<div v-if="itme.phone" id="bottom1">
						<img src="job_phone.png" alt="">
						<p>手机: {{itme.phone}} <span @click="click(itme.phone)">拨号</span></p>
					</div>
					<div v-if="itme.qq" id="bottom1">
						<img  src="job_qq.png" alt="">
						<p>QQ: {{itme.qq}} <span @click="$toast(itme.qq+ '复制成功');">复制</span></p>
					</div>
					<div v-if="itme.wechat" id="bottom1">
...
<script>
	import {jobDetail} from '../datas.js'
